...
#define Y_GAIN        0.24f
// 장착 회전 보정: 안경 프레임에 마이크 십자가 45도 돌아간 채(다이아몬드) 장착됨
// (2026-07-20 실측: 모든 화살표가 실제보다 반시계로 45도 치우침 → 시계방향 45도 보정).
// 표시 각도 = 측정 각도 + PHI_OFFSET_DEG. 재장착으로 각도가 바뀌면 이 값만 수정.
#define PHI_OFFSET_DEG  -45.0f
